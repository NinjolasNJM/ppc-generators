...
import strayOverlayTexture from "./textures/stray_overlay.png";
import boggedTexture from "./textures/bogged.png";
import boggedOverlayTexture from "./textures/bogged_overlay.png";
import parchedTexture from "./textures/parched.png";
// enderman texture and/or support?

const id = "minecraft-skeleton";

const name = "Minecraft Skeleton";

const history: HistoryDef = [
  "28 Oct NinjolasNJM - If this is still here then the Parched texture is probably not updated and neither is any other texture."
];
...
const textures: TextureDef[] = [
  ...
  {
    id: "Wither Skeleton",
    url: witherSkeletonTexture.src,
    standardWidth: 64,
    standardHeight: 32,
  },
  {
    id: "Stray",
    url: strayTexture.src,
    standardWidth: 64,
    standardHeight: 32,
  },
  {
    id: "Stray Overlay",
    url: strayOverlayTexture.src,
    standardWidth: 64,
    standardHeight: 32,
  },
  {
    id: "Bogged",
    url: boggedTexture.src,
    standardWidth: 64,
    standardHeight: 32,
  },
  {
    id: "Bogged Overlay",
    url: boggedOverlayTexture.src,
    standardWidth: 64,
    standardHeight: 32,
  },
  {
    id: "Parched",
    url: parchedTexture.src,
    standardWidth: 64,
    standardHeight: 64,
  },
];
// Parched is 64x64. This causes a potential future problem. Since we are building off of the character generator and we have the old char model working, this might be a problem that solves itself, or not.

const script: ScriptDef = (generator: Generator) => {
  const minecraftGenerator = new Minecraft(generator);
  // Define user inputs

  generator.defineSelectInput("Skin Model", ["Steve", "Alex"]);// make skeleton, stray/bogged, parched. Later can do wither skeleton, enderman, smash enderman(?), even player.
