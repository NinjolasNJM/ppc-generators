...
function makeFaces(ox: number, oy: number): Faces {
  return {
    ...
    right0: [ox + (size * 14) / 16, oy + size * 7 / 4, (size * 2) / 16, size / 4],
...
export function drawShelf(
  ...
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 0, 16, 16], regions.top0);
  Face.drawFace(
    generator,
    "ShelfFace" + blockId,
    [0, 0, 16, 16],
  ...
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 8, 16, 8], regions.right0);
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 8, 16, 8], regions.front0);
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 8, 16, 8], regions.left0);

    Face.drawFace(generator, "ShelfFace" + blockId, [0, 0, 16, 16], regions.top1);
  Face.drawFace(
    generator,
    "ShelfFace" + blockId,
    [0, 0, 16, 16],
  ...
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 8, 16, 8], regions.right1);
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 8, 16, 8], regions.front1);
  Face.drawFace(generator, "ShelfFace" + blockId, [0, 8, 16, 8], regions.left1);
