...
import { armorTintChoiceGroups } from "../_common/plugins/texturePicker/tints";
...
const script: ScriptDef = (generator: Generator) => {
  ...
  function getTint(colorId: string): Blend {
    const hex = defineTintInput(generator, colorId, {
      defaultValue: "#A06540",
      choiceGroups: armorTintChoiceGroups,
      includeNoTint: false,
    });

    return { kind: "MultiplyHex", hex: hex ?? "#A06540" };
  }
